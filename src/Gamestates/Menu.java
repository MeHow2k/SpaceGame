...
public class Menu {
    ...
    public void draw (Graphics2D g){
        ...
        g.drawString(gameStrings.getString("Start"), C.FRAME_WIDTH/2-100,325);
        g.setColor(Color.white);
        if(C.cursorPosition==1) g.setColor(selectedColor);
        g.drawString(gameStrings.getString("Jak grać?"),C.FRAME_WIDTH/2-100,425);
        g.setColor(Color.white);
        if(C.cursorPosition==2) g.setColor(selectedColor);
        g.drawString(gameStrings.getString("Opcje"),C.FRAME_WIDTH/2-100,525);
        g.setColor(Color.white);
        if(C.cursorPosition==3) g.setColor(selectedColor);
        g.drawString(gameStrings.getString("Autorzy"),C.FRAME_WIDTH/2-100,625);
        g.setColor(Color.white);
        if(C.cursorPosition==4) g.setColor(selectedColor);
        g.drawString(gameStrings.getString("Wyjście"),C.FRAME_WIDTH/2-100,725);
        g.setColor(Color.white);
